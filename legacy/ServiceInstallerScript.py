...
class PythonScriptService(win32serviceutil.ServiceFramework):
    ...
    _svc_description_ = """Automated BarCode Scanner is a service that scans files for barcodes, detects them, and filters the files based on barcode information.\n
    It reads input files, scans for barcodes, writes data to a database, and manages file movement.\n
    The service supports various photo types, enables rescanning of problem files, and offers easy installation and configuration.\n
